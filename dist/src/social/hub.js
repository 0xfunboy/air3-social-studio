...
export class SocialHub {
    ...
    async publish(e, p) {
        ...
        const a = e.data, c = this.credentials(e);
    ...
    async finalize(e, r) { assert(e.data.transport === 'direct' && this.isMeta(e.data), 'FINALIZE', 'Finalizzazione non prevista'); return this.meta.finalize(e.data, this.credentials(e), r); }
    async metrics(e, r) {
        const a = e.data, c = this.credentials(e);
        if (a.transport === 'postiz')
