...
const addAccount = (...args) => { const visible = publicAccount(...args); return args[0].studio.hub.account(args[0].p, visible.id); };
const post = (extra = {}) => ({ id: 'c'.repeat(32), title: 'Una domanda per la community', text: 'Quale idea vorresti condividere?', format: 'text', media: [], options: {}, ...extra });
...
//# sourceMappingURL=social-contracts.test.js.map